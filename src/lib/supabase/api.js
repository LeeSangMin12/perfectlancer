...
import { create_work_request_bookmarks_api } from '$lib/supabase/outsourcing/work_request_bookmarks';
...
export const create_api = (supabase) => ({
	...
	post_comment_reports: create_post_comment_reports_api(supabase),
	...
	service_reports: create_service_reports_api(supabase),
	...
	work_request_bookmarks: create_work_request_bookmarks_api(supabase),
